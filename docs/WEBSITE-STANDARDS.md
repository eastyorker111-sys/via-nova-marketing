...
6. Commit only intended files. A local commit is not a GitHub push; repository push authentication remains unresolved until a successful push is verified.
